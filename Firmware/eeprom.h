...
#define EEPROM_UVLO_UNUSED_002 (EEPROM_BELTSTATUS_Y - 81) //81*uint8_t (unused)
#define EEPROM_SD_SORT (EEPROM_UVLO_UNUSED_002 - 1) //0 -time, 1-alpha, 2-none
...
#define EEPROM_UVLO_UNUSED_006 (EEPROM_MMU_CUTTER_ENABLED - 288)

#define EEPROM_MBL_TYPE	(EEPROM_UVLO_UNUSED_006-1) //uint8_t for mesh bed leveling precision
...
#define EEPROM_UVLO_UNUSED_005 (EEPROM_FSENSOR_ACTION_NA - 18) // (unused)

#define EEPROM_BACKLIGHT_LEVEL_HIGH (EEPROM_UVLO_UNUSED_005-1) // uint8
...
#define EEPROM_UVLO_UNUSED_001 (EEPROM_BACKLIGHT_TIMEOUT-4) // (unused)

//This is supposed to point to last item to allow EEPROM overrun check. Please update when adding new items.
#define EEPROM_LAST_ITEM EEPROM_UVLO_UNUSED_001
// !!!!!
