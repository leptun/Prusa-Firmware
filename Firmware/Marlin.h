...
#define SERIAL_ACTION1(x) (SERIAL_PROTOCOLRPGM(MSG_OCTOPRINT_ACTION_BEGIN), SERIAL_PROTOCOLRPGM(x))
#define SERIAL_ACTION2(x,y) (SERIAL_PROTOCOLRPGM(MSG_OCTOPRINT_ACTION_BEGIN), SERIAL_PROTOCOLRPGM(x), SERIAL_PROTOCOLLN(y))
#define SERIAL_ACTIONPGM(x,y) (SERIAL_PROTOCOLRPGM(MSG_OCTOPRINT_ACTION_BEGIN), SERIAL_PROTOCOLRPGM(x), SERIAL_PROTOCOLLNRPGM(y))
