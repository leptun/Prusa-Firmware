...
#define HOMING_FEEDRATE {3000, 3000, 1200, 0}  // set the homing speeds (mm/min) // 3000 is also valid for stallGuard homing. Valid range: 2200 - 3000
...
#define DEFAULT_MAX_FEEDRATE                {300, 300, 20, 120}      // (mm/sec)   max feedrate (M203)
#define DEFAULT_MAX_FEEDRATE_SILENT         {100, 100, 12, 120}      // (mm/sec)   max feedrate (M203), silent mode

#define DEFAULT_MAX_ACCELERATION            {2000, 2000, 200, 5000}  // (mm/sec^2) max acceleration (M201)
...
#define TMC2130_SG_THRS_Z       6     // stallguard sensitivity for Z axis
#define TMC2130_SG_THRS_E       3     // stallguard sensitivity for E axis
#define TMC2130_SG_THRS_HOME {5, 3, TMC2130_SG_THRS_Z, TMC2130_SG_THRS_E}

//new settings is possible for vsense = 1, running current value > 31 set vsense to zero and shift both currents by 1 bit right (Z axis only)
#define TMC2130_CURRENTS_H {30, 30, 35, 30}  // default holding currents for all axes
#define TMC2130_CURRENTS_R {30, 30, 35, 30}  // default running currents for all axes
#define TMC2130_CURRENTS_R_HOME {30, 30, 20, 18}  // homing running currents for all axes
