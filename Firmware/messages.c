...
const char MSG_OCTOPRINT_ACTION_BEGIN[] PROGMEM_N1 = "//action:"; ////
const char MSG_OCTOPRINT_ACTION_PROMPT_BEGIN[] PROGMEM_N1 = "prompt_begin "; ////
const char MSG_OCTOPRINT_ACTION_PROMPT_CHOICE[] PROGMEM_N1 = "prompt_choice "; ////
const char MSG_OCTOPRINT_ACTION_PROMPT_SHOW[] PROGMEM_N1 = "prompt_show"; ////
const char MSG_OCTOPRINT_ACTION_PROMPT_END[] PROGMEM_N1 = "prompt_end"; ////
